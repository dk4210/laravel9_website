    ...
    <main>
        ...
        <section class="standard__blog">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        @foreach($allblogs as $bp)
                            <div class="standard__blog__post">
                                <div class="standard__blog__thumb">
                                    <a href="blog-details.html"><img src="{{ asset($bp->image) }}" alt=""></a>
                                    <a href="blog-details.html" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                                </div>
                                <div class="standard__blog__content">
                                    <div class="blog__post__avatar">
                                        <div class="thumb"><img src="{{ asset($bp->image) }}" alt=""></div>
                                        <span class="post__by">By : <a href="#">Halina Spond</a></span>
                                    </div>
                                    <h2 class="title"><a href="{{ route('blog.details', $bp->id) }}">{{ $bp->title }}</a></h2>
                                    <p>{!! Str::limit($bp->description, 200) !!}</p>
                                    <ul class="blog__post__meta">
                                        <li><i class="fal fa-calendar-alt"></i> {{ \Illuminate\Support\Carbon::parse($bp->created_at)->diffForHumans()}}</li>
                            ...
                            <div class="widget">
                                ...
                                <ul class="sidebar__cat">
                                    @foreach($categories as $all)
                                        <li class="sidebar__cat__item"><a href="{{ route('category.blog', $all->id) }}">{{ $all->blog_category }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="widget">
